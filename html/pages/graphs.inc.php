...
unset($vars['page']);
unset($device); // prevent leak from caching
...
if (is_filesystem_full($config['temp_dir'])) {
    ...
    print_box('<strong class="text-uppercase">The temporary directory is full. Graphs cannot be generated properly.</strong>', 'error');
    //echo '</div>';
}
