...
if (version_compare(get_versions('snmp'), '5.8', '<')) {
...
$form['row'][17]['snmp_authlevel']  = [
    ...
    'value'    => $vars['snmp_authlevel'] ?: $config['snmp']['v3'][0]['authlevel']
];
...
$form['row'][20]['snmp_authalgo']   = [
    ...
    'width'    => '250px',
    'values'   => $authalgo,
    'value'    => $vars['snmp_authalgo'] ?: $config['snmp']['v3'][0]['authalgo']
];
...
$form['row'][22]['snmp_cryptoalgo'] = [
    ...
    'width'    => '250px',
    'values'   => $cryptoalgo,
    'value'    => $vars['snmp_cryptoalgo'] ?: $config['snmp']['v3'][0]['cryptoalgo']
];
