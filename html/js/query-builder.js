...
QueryBuilder.DEFAULTS = {
    ...
    icons: {
        add_group:    'icon-plus-sign-alt',
        add_rule:     'icon-plus-sign',
        remove_group: 'icon-minus-sign-alt',
        remove_rule:  'icon-remove-sign',
...
<div id="${rule_id}" class="rule-container">
  <div class="rule-header">
    <div class="btn-group pull-right rule-actions">
      <button type="button" class="btn btn-xs btn-danger" style="margin: 5px;" data-delete="rule">
