...
$config['web_iframe']           = FALSE;       // Allow to run observium pages in iframe. Disabled by default.
...
$config['web_session_cidr']         = [];        // Allow user authorisation from certain IP ranges (when empty, allow from any)
...
$config['web_show_disabled']    = TRUE;    // Show or not disabled entities on major pages.
...
// Custom alerts status map, in notification message tag, use: %ALERT_STATUS_CUSTOM%
// 0 - ALERT, 1 - RECOVERY, 2 - DELAYED, 3 - SUPPRESSED
// $config['alerts']['status'][0] = '0'; // ALERT
...
//$config['geo_api']['opencage']['enable']       = TRUE;
//$config['geo_api']['opencage']['key']          = '';

//$config['geo_api']['locationiq']['enable']     = TRUE;
//$config['geo_api']['locationiq']['key']        = '';
...
$config['frontpage']['minigraphs']['height'] = 10;
...
/* DEPRECATED. Common subnet ignore, use $config['ip-address']['ignore_type'] instead
$config['ignore_common_subnet'][] = '127.0.0.1/32';   // (loopback) Common on Juniper
$config['ignore_common_subnet'][] = '127.0.0.0/8';    // (loopback) Common on Linux
$config['ignore_common_subnet'][] = '127.0.0.0/16';   // (loopback) Common on ZyXEL
$config['ignore_common_subnet'][] = '169.254.0.0/16'; // (link-local) DHCP fallback range
#$config['ignore_common_subnet'][] = '128.0.1.16/32';  // Common on Juniper
$config['ignore_common_subnet'][] = '::/0'; // (unspecified)
$config['ignore_common_subnet'][] = '::/64'; // (unspecified)
$config['ignore_common_subnet'][] = '::1/128';        // (loopback) Common on Linux
*/
