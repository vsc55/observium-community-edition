...
function process_syslog_line($line) {
    ...
    //var_dump($entry);
    //var_dump($GLOBALS['dev_cache']);
    if (!$entry['device_id']) {
        // Unknown (not associated) device
    ...
    if ($os_group === 'cisco') {
        print_debug("SYSLOG DEBUG: Cisco group...\n");
        ...
        print_debug("SYSLOG DEBUG: Juniper group...\n");
        ...
        print_debug("SYSLOG DEBUG: Cisco WAP200...\n");
        ...
        print_debug("SYSLOG DEBUG: UNIX group...\n");
        if (str_contains($entry['tag'], '/')) {
        ...
        print_debug("SYSLOG DEBUG: Netscaler os...\n");
    ...
    } elseif ($os === 'nos' || $entry['program'] === 'raslogd' || str_starts_with($entry['tag'], 'raslogd')) {
        print_debug("SYSLOG DEBUG: Brocade NOS...\n");
        ...
        print_debug("SYSLOG DEBUG: Ubiquiti Unifi...\n");
        ...
        print_debug("SYSLOG DEBUG: Mikrotik and others...\n");
